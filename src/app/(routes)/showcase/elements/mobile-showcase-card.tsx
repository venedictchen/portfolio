...
export default function MobileShowcaseCard({
  showcase,
  ...
  return (
    <motion.div
      ref={cardRef}
      className="relative bg-gradient-to-br from-[#4A1B12]/80 to-[#3A0F09]/90 backdrop-blur-sm rounded-2xl overflow-hidden cursor-pointer h-96 border border-[#F9A826]/20"
