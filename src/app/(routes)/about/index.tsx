  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div
          className={`grid ${
            windowWidth >= 768 ? "md:grid-cols-2" : "grid-cols-1"
        ...
        >
          ...
          >
            ...
            <motion.div
              className="profile-image-wrapper relative w-full h-full overflow-hidden rounded-full shadow-xl sm:shadow-2xl shadow-[#F9A826]/30"
