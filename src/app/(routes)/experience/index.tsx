  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute top-20 right-20 w-32 h-32 rounded-full bg-gradient-to-r from-[#fda237] to-[#ab3a12] blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 360],
            opacity: [0.1, 0.3, 0.1],
        ...
        />
        <motion.div
          className="absolute bottom-20 left-20 w-40 h-40 rounded-full bg-gradient-to-r from-[#d37070] to-[#8b0000] blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            rotate: [360, 0],
            opacity: [0.1, 0.2, 0.1],
